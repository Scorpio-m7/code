...
# 扫描
def get_url():
    f = open("G:/xray_windows_amd64.exe1.6/xray_url.txt")
    lines = f.readlines()
    # 匹配http | https请求头
...
def do_scan(targeturl, outputfilename="test"):
    scan_command = "G:/xray_windows_amd64.exe1.6/xray_windows_amd64.exe webscan --basic-crawler {} --html-output {}.html".format(
        targeturl, outputfilename)
