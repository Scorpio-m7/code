...
#***************************************************表操作****************************************************
create table test.class(id int primary key auto_increment,name varchar(10) comment '名字',age int) charset utf8;#在指定数据库下创建数据表,id为主键自动增长(自增长一表一个),varchar最多存储21844个utf8字符,最大存储32766个gbk字符
...
#***************************************************数据操作****************************************************
insert into class (age,name) values(30,'jack'),(20,'anne'),(30,'lucy');#插入数据
